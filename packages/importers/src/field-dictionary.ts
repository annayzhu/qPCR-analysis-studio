...
export const FIELD_SYNONYMS: Record<CanonicalField, readonly string[]> = {
  ...
  cycleType: ["Cycle Type", "Quantification Type", "Cycle Term", "定量类型", "循环类型"],
  deltaCq: ["Delta Cq", "Delta Ct", "Delta Cp", "ΔCq", "ΔCt", "ΔCp", "DeltaCq", "DeltaCt", "DeltaCp"],
  deltaDeltaCq: ["Delta Delta Cq", "Delta Delta Ct", "Delta Delta Cp", "ΔΔCq", "ΔΔCt", "ΔΔCp", "DeltaDeltaCq", "DeltaDeltaCt", "DeltaDeltaCp"],
